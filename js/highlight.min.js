...
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,p,o]}]}}})());hljs.registerLanguage("pgsql",(()=>{"use strict";return E=>{
...
aliases:["yml"],contains:b}}})());hljs.registerLanguage("scala",(()=>{"use strict";return e=>{const n={
...
begin:"@[A-Za-z]+"}]}}})());hljs.registerLanguage("sql",(()=>{"use strict";function e(e){
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:c}}})());hljs.registerLanguage("oxygene",(()=>{"use strict";return e=>{const n={
$pattern:/\.?\w+/,
...
contains:[t,s,r,a,e.C_LINE_COMMENT_MODE,i]}]}}})());hljs.registerLanguage("openscad",(()=>{"use strict";return e=>{const n={
...
begin:"[*!#%]",relevance:0},a]}}})());hljs.registerLanguage("diff",(()=>{"use strict";function e(...e){
return"("+((e=>{const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
}),n,{begin:"->|<-"}]}}})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
}],a.contains=n.contains,n}})());hljs.registerLanguage("rust",(()=>{"use strict";function e(...e){
...
relevance:0},{begin:/->/}]})})());hljs.registerLanguage("perl",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
},...B,..._,...M,I,P,...z,...q,U,V]}}})());hljs.registerLanguage("ruleslanguage",(()=>{"use strict";return T=>({
...
},{className:"string",begin:/'/,end:/'/},n]}}})());hljs.registerLanguage("d",(()=>{"use strict";return e=>{const a={
...
begin:"@[a-zA-Z_][a-zA-Z_\\d]*"}]}}})());hljs.registerLanguage("css",(()=>{"use strict"
...
contains:[c]}]}}})());hljs.registerLanguage("lisp",(()=>{"use strict";return e=>{
